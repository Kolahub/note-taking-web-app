...
function NoteForm() {
  ...
  return (
    <Form
      ...
      className="px-4 pt-0 pb-16 sm:px-6 flex flex-col border-r-2 border-gray-200 dark:border-gray-800 lg:py-3 h-[calc(100vh-120px)] lg:h-[calc(100vh-85px)] text-sm sm:text-base"
    >
      {/* Title Input */}
      <input
        type="text"
