...
function Tags() {
    ...
    return (
      <div className="bg-white dark:bg-black h-full p-4">
        {tags.length === 0 ? (
          ...
          <div className='flex-1 h-full min-h-0 overflow-y-auto scrollbar-hide -mx-4 px-4' style={{
  ...
  return (
    <div className="mt-4 py-2">
      ...
      <div className="mt-2 flex-1 max-h-full min-h-0 overflow-y-auto scrollbar-hide">
        {tags.map((tag, i) => (
          <button
            key={`${tag}${i}`}
            onClick={() => handleFilterBasedTags(tag)}
