...
function Tags() {
  ...
  return (
    <div>
      ...
      <div className="mt-2">
        {tags.map((tag, i) => (
          <button className="group flex justify-between items-center w-full mb-1 last:mb-0 rounded-lg hover:bg-gray-100" key={`${tag}${i}`}>
            <div className="flex gap-2 p-3">
              <svg
                ...
                fill="none"
                viewBox="0 0 24 24"
                className="text-[#0E121B] group-hover:text-blue-500 group-active:text-blue-500"
              >
                <path
                  stroke="currentColor"
                  strokeLinecap="round"
            ...
            {/* Arrow SVG: hidden by default, shows on hover/active */}
