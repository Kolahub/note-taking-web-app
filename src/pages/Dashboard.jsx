...
//       <div className="lg:w-[280px] lg:h-screen lg:flex-shrink-0 border-r-2 px-4 pt-3">
//           <div className="mb-4"> 
//           <img src={logo} alt="Logo" className="w-32"/> 
//           </div>
//           <Navbar />
...
//         <div className="flex items-center justify-between h-20 px-8 py-[18.5px] border-b-2">
//           <h1 className="capitalize text-3xl font-bold">all notes</h1>
//           <div className="flex gap-4">
//             <input type="text" className="border-2 rounded-lg focus:outline-none p-2 w-[320px]"/>
//             <button type="button">
